...
export default function OnboardingScreen() {
  const { fontSize, fontFamily, spacing, radius } = useTheme();
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", gap: spacing.md, marginBottom: spacing.xl }}>
          {OZELLIKLER.map((o) => (
            ...
            >
              ...
              <Text style={{ color: "#F8FAFC", fontSize: fontSize.sm, fontFamily: fontFamily.bold }}>
                {o.baslik}
              </Text>
              <Text style={{ color: "#CBD5E1", fontSize: fontSize.xs, lineHeight: 17 }}>
                {o.metin}
              </Text>
            </View>
          ))}
